...
describe Restfolia::EntryPoint do
  ...
  it "should raise exception when url is empty" do
    ...
    lambda { ep.expand(:teste => false) }.should raise_error ArgumentError, Restfolia::ExpansionSupport::INVALID_URL
  end
  ...
  it "should raise exception when params is not a valid hash" do
    ...
    lambda { ep.expand(:what) }.should raise_error ArgumentError, Restfolia::ExpansionSupport::INVALID_PARAMETER
  end
